...
public class HiFlowLayout extends ViewGroup {
    public HiFlowLayout(Context context) {
        super(context);
    }

    public HiFlowLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public HiFlowLayout(Context context, AttributeSet attrs, int defStyleAttr) {
