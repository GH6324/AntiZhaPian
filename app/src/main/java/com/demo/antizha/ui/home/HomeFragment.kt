...
class ToolHolderAdapte : RecyclerView.Adapter<ToolViewHolder> {
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, i: Int): ToolViewHolder {
        return ToolViewHolder(LayoutInflater.from(context).inflate(R.layout.tool_item, viewGroup, false))
    }
...
class NewCaseHolderAdapte : RecyclerView.Adapter<NewCaseViewHolder> {
    ...
    constructor(context: Context, view:View, recycle:androidx.recyclerview.widget.RecyclerView, list: ArrayList<NewCase>) {
        this.context = context
        this.list = list
        this.view = view
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, i: Int): NewCaseViewHolder {
        return NewCaseViewHolder(LayoutInflater.from(context).inflate(R.layout.item_home_new_case, viewGroup, false))
    }
    ...
    fun addNewCase(newCase:NewCase){
        list.add(newCase)
        this.recycle.getLayoutParams()?.height = context.resources.displayMetrics.density.let { (100 * list.size * it + 0.5).toInt()}
    }
...
class HomeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val toolimage = arrayOf(R.drawable.iv_home_report, R.drawable.iv_home_case, R.drawable.iv_home_warn, R.drawable.iv_home_id_check)
        ...
        this.newCaseAdapter = NewCaseHolderAdapte(root.getContext(), root, newCaseRecycle, ArrayList<NewCase>())
    ...
    fun getNewCaseApi(page: Int, row: Int) {
        ...
        getDataByGet("https://fzapp.gjfzpt.cn/hicore/api/Information/querylatestcases?Page=" + page.toString() + "&Rows=" + row.toString() + "&Sort=releasetime&Order=desc",
            callBackFunc = this::AddNewCase2)
    }
    fun AddNewCase2(data:String){
