...
class RequestParamInterceptor: Interceptor {
    ...
    fun setHeader(builder: Request.Builder?) {
        if (builder != null) {
            ...
            builder.addHeader("app-version", SystemUtils.getAppVer())
            builder.addHeader("imei", UserInfoBean.imei)
            builder.addHeader("app-version-code", SystemUtils.getAppVerCode().toString() + "")
            ...
            builder.addHeader("longitude", UserInfoBean.longitude)//RegionConfigHttp.getLongtude().toString() + "")  //经度
            builder.addHeader("latitude", UserInfoBean.latitude)//RegionConfigHttp.getLatitude().toString() + "")   //维度
